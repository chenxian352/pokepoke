...
class HomeScreen extends Component {
  ...
  componentDidMount() {
    this.props.getPokemonList() // bound action
  }
  ...
  renderNameAndBasis = stagePokemon => (
    ...
    return (
      <LinearGradient colors={ ['#32799D', '#85C2E2'] } style={ styles.backdrop }>
        <SafeAreaView style={ [styles.safeView] }>
          { this.renderStage(stagePokemon) }
          { this.renderNameAndBasis(stagePokemon) }
          { this.renderSpecs(stagePokemon) }
          { this.renderList(stagePokemon) }
        </SafeAreaView>
      </LinearGradient>
    )
  }
